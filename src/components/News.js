    ...
    <>
      <div className="container my-3">
        <h1 className="text-center" style={{ marginTop: "70px" }}>
          <img
            style={{ width: "45px", marginTop: "-7px", borderRadius: "50%" }}
          ...
          />
          LazyBee Media - Top{" "}
          {props.category === "General" ? "" : props.category} Headlines
        </h1>
        {loading && (
          <div
            ...
            style={{ height: "450px" }}
          >
            <span className="loader" style={{ marginLeft: "-2rem" }}></span>
          </div>
        )}
        {!loading && (
          <div className="row">
                ...
                <div className="col md-4 my-3" key={e.url}>
                  <NewsItem
                    ...
                    imageUrl={
                      e.urlToImage
                        ? e.urlToImage
                        : "https://images.albertsons-media.com/is/image/ABS/960309661?$ng-ecom-pdp-desktop$&defaultImage=Not_Available"
                    }
                    newsUrl={e.url}
                    author={e.author}
